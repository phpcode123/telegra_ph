...
abstract class BaseController
{
    ...
    //
	// 以下为新增，为了使用旧版的 success error redirect 跳转  start  20221026
	//
     ...
     * @return void
     */
    protected function success($msg = '', string $url = null, int $wait = 3)
    {
     ...
     * @return void
     */
    protected function error($msg = '', string $url = null, int $wait = 3)
    {
        if (is_null($url) && isset($_SERVER["HTTP_REFERER"])) {
            $url = $_SERVER["HTTP_REFERER"];
        } elseif ($url) {
